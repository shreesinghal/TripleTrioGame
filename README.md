...
**Modification of existing code**: We did not modify any of the existing code base from our previous projects. However, we did add onto classes like GridPanel.java and TTFrameViewImpl.java in cs3500.tripletrios.view. We added methods and fields to account for the wrapper class in GridPanel.java. We also added a keyListener in TTFrameViewImpl.java to account for finding the hints. **In order to get the hints to show up, we press H and they will show up**
